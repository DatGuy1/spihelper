...
import { isNonRegisteredAccount, setupDefaultBlockRowData } from '../utils.ts';
import { parseUserTags } from '../tags.ts';
import { spiHelperSettings } from '../options';
import { tableRowIdentifier } from './runtime.ts';
...
export function setUserRowData(opts: {
  ...
  defaultBlock: boolean;
  state: CaseState;
}): { userRow: UserRow; globalStatus: GlobalStatus } {
